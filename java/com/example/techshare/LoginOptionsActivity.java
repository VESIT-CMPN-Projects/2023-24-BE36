...
import com.example.techshare.databinding.ActivityLoginOptionsBinding;
...
public class LoginOptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("156610742920-4uksb4k33huapkjqj1s8orj7otmh7m38.apps.googleusercontent.com")
                .requestEmail()
                .build();

        mGoogleSignInClient = GoogleSignIn.getClient(LoginOptionsActivity.this, gso);
