...
import com.example.techshare.databinding.ActivityRegisterEmailBinding;
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        Log.d(TAG, "onSuccess:Account Created:D");
                        updateUserInfo();
        ...
        reference.child(registerUserUid)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Log.e(TAG, "onFailure: ",e);
                        progressDialog.dismiss();
                        Utils.toast(RegisterEmailActivity.this,"Failed to save due to"+e.getMessage());
