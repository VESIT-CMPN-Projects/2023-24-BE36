...
import com.example.techshare.databinding.ActivityChangePasswordBinding;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private void  validateData(){
        ...
        if (currentPassword.isEmpty()){
            ...
            binding.currentPasswordEt.setError("Enter password you remember!");
            binding.currentPasswordEt.requestFocus();
        } else if (newPassword.isEmpty()) {

            binding.newPasswordEt.setError(" New Password not entered.");
            binding.newPasswordEt.requestFocus();
        } else if (confirmNewPassword.isEmpty()) {

            binding.confirmNewPasswordEt.setError("Confirm Password not entered.");
