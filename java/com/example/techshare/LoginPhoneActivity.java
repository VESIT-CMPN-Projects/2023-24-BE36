...
import com.example.techshare.databinding.ActivityLoginPhoneBinding;
...
public class LoginPhoneActivity extends AppCompatActivity {
        ...
        binding.verifyOtpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otp.isEmpty()) {
                    ...
                    binding.otpEt.setError("OTP length must be only 6 characters");
                    binding.otpEt.requestFocus();
                }
                else {
    ...
    private void validateData() {
        phoneCode = binding.phoneCodeTil.getSelectedCountryCode();
    ...
    private void phoneLoginCallBack(){
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                Utils.toast(LoginPhoneActivity.this,"OTP SENT"+phoneNumberWithCode);

                binding.loginLabelTv.setText("Please type the verification code sent to"+    phoneNumber);
